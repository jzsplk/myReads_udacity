...
class BooksApp extends React.Component {
  ...
  render() {
    ...
    readingBooks = this.state.books.filter(book => book.status === "Currently Reading");
    wantToReadBooks = this.state.books.filter(book => book.status === "Want to Read");
    readingBooks = this.state.books.filter(book => book.status === "Read");
